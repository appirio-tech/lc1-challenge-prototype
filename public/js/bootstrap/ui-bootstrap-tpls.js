...
angular.module("template/modal/window.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/modal/window.html",
    ...
    "    <div class=\"modal-dialog\" ng-class=\"{'modal-sm': size == 'sm', 'modal-lg': size == 'lg'}\" force-click data-ng-style=\"middle('.modal-dialog')\" data-resize><div class=\"modal-content\" ng-transclude></div></div>\n" +
    "</div>");
}]);
